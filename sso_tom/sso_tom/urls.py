...
urlpatterns = [
    ...
    path(
        ...
        CustomObservationCreateView.as_view(),
        name="create",
    ),
    path(
        "observations/template/<str:facility>/create/",
        CustomObservationTemplateCreateView.as_view(),
        name="template-create",
    ),
    path(
        "observations/template/<int:pk>/update/",
        CustomObservationTemplateUpdateView.as_view(),
        name="template-update",
    ),
    path(
        "observations/template/<int:pk>/",
        CustomObservationTemplateUpdateView.as_view(),
