...
from .views import SingleObservationCreateView, ChainListView, ChainCreateView, ChainView, ChainedTargetDetailView, \
    ChainTemplateCreateView, ChainTemplateListView, ChainTemplateView, ChainedTemplateCreateView

app_name = 'chains'

urlpatterns = [
    path('add/', ChainCreateView.as_view(), name='add_chain'),
    path('templates/add/', ChainTemplateCreateView.as_view(), name='add_chain_template'),
